    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public static SubmissionInfo CreateDebugSubmissionInfo()
        {
            return new SubmissionInfo()
            {
                ...
                {
                    Layer0MasteringCode = "Layer0 Mastering Code",
                    Layer0MasteringSID = "Layer0 Mastering SID",
                    Layer0Toolstamps = "Layer0 Toolstamp",
                    Layer0MouldSIDs = "Layer0 Mould SIDs",
                    Layer0AdditionalMoulds = "Layer0 Additional Moulds",

                    Layer1MasteringCode = "Layer1 Mastering Code",
                    Layer1MasteringSID = "Layer1 Mastering SID",
                    Layer1Toolstamps = "Layer1 Toolstamp",
                    Layer1MouldSIDs = "Layer1 Mould SIDs",
                    Layer1AdditionalMoulds = "Layer1 Additional Moulds",

                    Layer2MasteringCode = "Layer2 Mastering Code",
                    Layer2MasteringSID = "Layer2 Mastering SID",
                    Layer2Toolstamps = "Layer2 Toolstamp",
                    Layer2MouldSIDs = "Layer2 Mould SIDs",
                    Layer2AdditionalMoulds = "Layer2 Additional Moulds",

                    Layer3MasteringCode = "Layer3 Mastering Code",
                    Layer3MasteringSID = "Layer3 Mastering SID",
                    Layer3Toolstamps = "Layer3 Toolstamp",
                    Layer3MouldSIDs = "Layer3 Mould SIDs",
                    Layer3AdditionalMoulds = "Layer3 Additional Moulds",
