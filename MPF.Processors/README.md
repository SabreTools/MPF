...
This library represents the logic needed to process the outputs of 8 different dumping programs:
...
- Additional generic output support that is not program-specific

These processors allow for extracting a large amount of information from the output files generated by each of the programs. This information is then formatted according to the requirements of [Redump](http://redump.info/), which provides an easy comparison point.
